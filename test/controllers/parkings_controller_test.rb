...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { car_id: @parking.car_id, user_id: @parking.user_id } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { car_id: @parking.car_id, user_id: @parking.user_id } }
